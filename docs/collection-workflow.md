...
The [human and agentic discovery design](agentic-collection-discovery.md) updates the product direction below: human-led and agent-led discovery and preparation are parallel contribution flows. Its [implementation plan](collection-workflow-implementation-plan.md) replaces the earlier manual-first delivery order. The source, claim, identity and publication boundaries below remain applicable; the requirement to defer AI until the manual workflow is complete is superseded.
