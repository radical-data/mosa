...
A maintainer makes a separate publication decision. The public website reads only the approved static snapshot and has no database connection. Hoa Hakananaiʻa is live at [museumofstolenartefacts.org](https://museumofstolenartefacts.org/). The research app is deployed at [research.museumofstolenartefacts.org](https://research.museumofstolenartefacts.org/), as confirmed by the project owner on 2026-09-22. Verification of researcher sign-in, draft saving and a real second-object publication remains on the delivery checklist.
